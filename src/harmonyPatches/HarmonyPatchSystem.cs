...
namespace VillageResearch
{
	namespace HarmonyPatches
	{
		...
		public class VSHarmonyPatchSystem : ModSystem
		{
			...
			private readonly string harmonyId = "vs.teacupangel.villageresearch";
		...
		public abstract class VSHarmonyPatchBase
		{
			...
			{
				return new HarmonyMethod(this.GetType().GetMethod(methodName, BindingFlags.Static | BindingFlags.NonPublic));
			}
		}
	}
}